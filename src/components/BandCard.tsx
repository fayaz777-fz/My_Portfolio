...
const CARD_TEXTURE_PATH = "/assets/card_fayaz.png";
...
function Band({
  ...
  const fayazCardTexture = useTexture(CARD_TEXTURE_PATH);
  fayazCardTexture.flipY = false;
  fayazCardTexture.needsUpdate = true;

  useEffect(() => {
    if (materials?.base) {
      materials.base.map = fayazCardTexture;
      materials.base.needsUpdate = true;
    }
  }, [materials, fayazCardTexture]);
