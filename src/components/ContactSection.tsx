                        ...
                        <div className="flex items-center justify-center lg:justify-start gap-5 mt-2">
                            ...
                            >
                                <div className="relative w-12 h-12 sm:w-14 sm:h-14 rounded-2xl
                                    ...
                                    group-hover:shadow-[0_0_25px_rgba(234,67,53,0.2)]">
                                    <FaEnvelope
                                    ...
                                    <div
                                        ...
                                        style={{
                                            background:
                                                "linear-gradient(135deg, rgba(234,67,53,0.08), transparent)",
                                        }}
                                    />
                                </div>
                                <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-white/40 group-hover:text-red-400 transition-colors duration-300">
                                    Gmail
                                </span>
                            </a>
                            ...
                            >
                                <div className="relative w-12 h-12 sm:w-14 sm:h-14 rounded-2xl
                                    ...
                                    group-hover:shadow-[0_0_30px_rgba(34,197,94,0.25)]">
                                    <FaWhatsapp
                                ...
                                <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-white/40 group-hover:text-green-400 transition-colors duration-300">
                                    WhatsApp
                                </span>
                            </a>
                        </div>
